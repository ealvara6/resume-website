                        ...
                        <Grid item xs={12} lg={4}>
                            <Box className={classes.block}>
                                ...
                                <Grid container className={classes.buttons} xs={12}>
                                    ...
                                    <Grid item>
                                        <NavButton handleClick={handleComponentChange} mobileView={mobileView} color="#f50057" slide={1800} title="Projects" textColor="#fff"/>
                                    </Grid>
                                    <Grid item>
                                        <NavButton handleClick={handleComponentChange} mobileView={mobileView} color="#f44336" slide={2100} title="Contact" textColor="#fff"/>
                                    </Grid>
                                </Grid>
                            </Box>
                        </Grid>
